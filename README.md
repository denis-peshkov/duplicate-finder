...
Homebrew will only accept this project into [homebrew-core](https://github.com/Homebrew/homebrew-core) once the GitHub repo is “notable” enough: roughly **≥225** ![Star](docs/readme-icons/star-light.svg#gh-light-mode-only)![Star](docs/readme-icons/star-dark.svg#gh-dark-mode-only) **Star**, **≥90** ![Fork](docs/readme-icons/fork-light.svg#gh-light-mode-only)![Fork](docs/readme-icons/fork-dark.svg#gh-dark-mode-only) **Fork**, and **≥90** ![Watch](docs/readme-icons/watch-light.svg#gh-light-mode-only)![Watch](docs/readme-icons/watch-dark.svg#gh-dark-mode-only) **Watch**. If you find Duplicate Finder useful, use the buttons at the top of this page — thank you.
